...
const Newsletter = () => {
  ...
  return (
    <section className="container mx-auto px-4 py-16">
      ...
      <div className="bg-gradient-to-r from-[#006B3F]/10 via-white to-[#B91C1C]/10 p-8 rounded-lg flex items-center justify-between max-w-6xl mx-auto">
        <div className="flex-1 pr-8">
          ...
          <form onSubmit={handleSubmit} className="flex gap-4">
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-[#006B3F] to-[#000000] text-white px-6 py-2 rounded-md hover:opacity-90 transition-all"
            >
              Subscribe
            </button>
          </form>

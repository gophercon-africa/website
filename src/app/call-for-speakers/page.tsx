    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-brand dark:text-brand-bright mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex justify-center py-3 px-6 rounded-lg font-medium text-brand dark:text-brand-bright border border-brand hover:bg-brand/5 transition-colors"
            >
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="prose prose-lg max-w-none">
        <h1 className="text-4xl font-bold text-brand dark:text-brand-bright mb-8">
        ...
        <h2 className="text-2xl font-bold text-brand dark:text-brand-bright mt-12 mb-6">Session Types</h2>
        ...
        <h2 className="text-2xl font-bold text-brand dark:text-brand-bright mt-12 mb-6">Session Tracks</h2>
        <ul className="list-disc pl-6 space-y-2">
          <li>Go Core Track</li>
        ...
        <h2 className="text-2xl font-bold text-brand dark:text-brand-bright mt-12 mb-6">Topics We&apos;re Looking For</h2>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <h2 className="text-2xl font-bold text-brand dark:text-brand-bright mt-12 mb-6">Submission Guidelines</h2>
        ...
        <h2 className="text-2xl font-bold text-brand dark:text-brand-bright mt-12 mb-6">Helpful Resources</h2>
          ...
          <ul className="space-y-4">
            <li>
              <a 
                ...
                className="text-brand dark:text-brand-bright hover:text-brand-light font-medium flex items-center"
              >
        ...
        <div className="bg-brand/10 p-6 rounded-lg mt-12 mb-8">
          <h2 className="text-2xl font-bold text-brand dark:text-brand-bright mb-4">We Encourage Submissions From:</h2>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <div className="mt-12 space-y-6">
          ...
          <p>
            ...
            <a href="mailto:hello@gophers.africa" className="ml-2 text-brand dark:text-brand-bright hover:text-brand-light font-medium">
